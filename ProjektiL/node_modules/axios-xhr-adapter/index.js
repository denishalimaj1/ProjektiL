...
module.exports = function creatAdapter(getRequestCallback) {
  return function xhrAdapter(config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      // let XRQ = window.wx ? window.wx.XMLHttpRequest : XMLHttpRequest;
      // let request = new XRQ();
      // request.dataType = "json"
      let request = getRequestCallback()
